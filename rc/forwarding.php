...
else if(isset($arr['questionList']) || isset($arr['studentTestQuery']) || isset($arr['studentResponseQuery']) || isset($arr['studentGetGrade']) || isset($arr['teacherGetGrade']) || isset($arr['teacherManageTests']) || isset($arr['makeGradesVisible']) || isset($arr['makeTestTakeable']) || isset($arr['addQuestion'])){
